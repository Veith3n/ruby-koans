...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # creates a new object with given value in a block and allows to do operations on all elements from collection.
    # After block is finished returns injected object
  end
