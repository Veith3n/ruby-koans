...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # there was no 'z' char in the string
  end
  ...
  # '*' returns as many characters as possible, you may end up with more data the you wanted
  ...
  # character class is just for the characters and it is faster
